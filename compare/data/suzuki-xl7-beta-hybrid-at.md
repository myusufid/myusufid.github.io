# Suzuki XL7 Beta Hybrid AT

## Basic Information
- **Brand:** Suzuki
- **Model:** XL7
- **Trim:** Beta Hybrid AT
- **Price:** Rp 297.000.000 (OTR Jakarta Feb 2026)
- **Segment:** SUV 7-Seater
- **Seating Capacity:** 7
- **Colors (Beta):** Metallic Magma Grey, Snow White Pearl, Cool Black

## Technical Specifications
- **Engine Type:** K15B + SMART HYBRID VEHICLE BY SUZUKI (SHVS)
- **Cylinders:** 4
- **Valves:** 16
- **Displacement:** 1462 cc
- **Bore x Stroke:** 74.0 x 85.0 mm
- **Compression Ratio:** 10.5
- **Maximum Output:** 104.7 PS (77 kW) / 6.000 rpm
...
### Capacities
- **Fuel Tank:** 45 L
- **Boot Space (3rd row up):** 153 L
- **Boot Space (3rd row down):** 803 L
- **Weight (GVW):** 1730 kg
...
## Features (Beta Hybrid Trim)
### Safety & Security
- 2 Airbags (Dual SRS)
- ESP (Electronic Stability Program)
- Hill Hold Control (A/T)
...
- E-Mirror Touchscreen with Digital Video Recorder (DVR)
- Auto Climate AC with Heater
- Cruise Control
- Keyless Push Start System
- Ventilated Cup Holders
- Centre Arm Rest (1st & 2nd row)
- Tilt Steering

### Exterior
- LED Headlamps with DRL & Guide Me Light
- LED Rear Combination Lamps
- Black Front Grille with Chrome Accent
- Chrome Outside Door Handles
- Roof Rails (Silver)
- 16-inch Black Paint Alloy Wheels

## Fuel Efficiency
- **City (Stop-Go):** 12.8 km/L (Estimated)
- **Highway (Tol):** 17.2 km/L (Estimated)
- **Combined:** 14.5 km/L (Estimated)
- **Fuel Recommendation:** Pertalite / Pertamax (RON 90+)
...
- **Depreciation Risk:** Very Low

## Official Links
- [Official Website](https://www.suzuki.co.id/cars/xl7-hybrid)
- [Brochure PDF](../brochure/xl7.pdf)
